/* P3 红线 B 复核：用户真实数据目录跑测前后零变化（清单 + 尺寸 + mtime 三口径）
   用法：node docs/问题核查资料_20260908/p3/_verify_datadir_redline.mjs
   基线：同目录 _datadir_baseline_prerun.json（P3 跑测前采集，ConvertTo-Json 写出） */
import fs from "node:fs";
import path from "node:path";

const BASE = "docs/问题核查资料_20260908/p3/_datadir_baseline_prerun.json";
